...
import com.za.spring.fun.mixconfig.RepositoryMixConfig;
import com.za.spring.fun.model.Item;
import com.za.spring.fun.model.PropertyDefinition;

/**
 * Integration test showing basic usage of {@link ItemRepository} using XML and Java configuration.
 *
 * @author Zoltan Altfatter
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(classes = RepositoryMixConfig.class)
@Transactional
public class ItemRepositoryMixConfigTest {
