...
/**
 * Integration test showing basic usage of {@link ItemRepository} using XML configuration.
 *
 * @author Zoltan Altfatter
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = "classpath:config/repository-config.xml")
@Transactional
public class ItemRepositoryXMLConfigTest {
